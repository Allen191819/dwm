...
static const char *colors[][3]           = { [SchemeNorm] = { "#bbbbbb", "#333333", "#444444" }, [SchemeSel] = { "#ffffff", "#37474F", "#42A5F5" }, [SchemeHid] = { "#dddddd", "#333333", "#42A5F5" }, [SchemeSystray] = { "#7799AA", "#7799AA", "#7799AA" } };
...
static Key keys[] = {
    ...
    TAGKEYS(XK_7, 6,  0,  0)
    TAGKEYS(XK_8, 7,  0,  0)
    TAGKEYS(XK_9, 8,  "~/scripts/app-starter.sh pcmanfm", 0)
    TAGKEYS(XK_c, 9,  "~/scripts/app-starter.sh browser", 0)
    TAGKEYS(XK_p, 10,  "~/scripts/app-starter.sh music",  0)
    TAGKEYS(XK_m, 11, "~/scripts/app-starter.sh pavucontrol", 0)
